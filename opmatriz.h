...
void escalonar(float ***matriz,int n,int m,float ***matriz2,int imprime);//escalona a matriz, resolve o sistema,colocando o resultado na matriz2 e imprime processos realizados
